...
class PLDPStudyForm(forms.Form, BaseFormFieldPluginForm):
    ...
    label = forms.CharField(label="Label",
                            ...
                            number of people of a specific study range. Change \
    ...
    study = forms.ChoiceField(choices=[],
                              ...
                              "survey belongs. Users will be able to "
                              "change this selection when running "
                              "the survey.",
    ...
    def __init__(self, *args, **kwargs):
        ...
        print(self.fields['study'].choices)
