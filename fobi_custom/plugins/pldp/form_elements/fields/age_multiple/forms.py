...
from pldp.forms import AGE_BASIC_CHOICES, AGE_DETAILED_CHOICES, AGE_COMPLEX_CHOICES
...
class PLDPAgeMultipleForm(forms.Form, BasePluginForm):
    ...
    choice_list = (('basic', tuple(AGE_BASIC_CHOICES)),
    ...
    name = forms.CharField(label="Name",
                            required=True)
    age = forms.ChoiceField(choices=tuple(choice_list),
